...
public class Poisonball extends Projectile {
    ...
    private PoisonMonster poisonMonster;

    public Poisonball(IRoom room, float angle, float initialX, float initialY,
        ...
        this.poisonMonster = poisonMonster;
        this.angle = angle;
    }
    ...
    private void resetPosition() {
        this.getHitbox().moveTo(poisonMonster.getHitbox().getCenter());
        Point pCenter = poisonMonster.getRoom().getPlayer().getHitbox().getCenter();
        Point mCenter = poisonMonster.getHitbox().getCenter();
